...
@layer components {
  .stats {
    @apply bg-[#091F1C] text-white p-4 flex-1 rounded-md border-2 border-[#004bad];
  }

  .stats-container {
    @apply bg-[#091F1C] p-5 rounded-lg border-[#004bad] border;
  }
  ...
  return (
    <div className="stats-container space-y-2">
      <div className="stats-container">
        ...
        <div className="flex text-white items-center space-x-2 bg-[#091B18]  border-[#004bad] border p-4">
          <p>TICKETS</p>
          <input
            type="number"
...
@layer components {
  ...
  .adminBtn {
    @apply bg-[#091F1C] p-2 flex-1 rounded-md border-[#004bad] border-2 hover:bg-emerald-500/50;
  }
}
