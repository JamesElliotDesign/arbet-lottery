  ...
  return (
    <div className="stats-container space-y-2">
      <div className="stats-container">
        ...
        <div className="flex text-white items-center space-x-2 bg-[#213148]  border-[#12aafe] border p-4">
          <p>TICKETS</p>
          <input
            type="number"
        ...
        <button
          ...
          className="mt-5 w-full bg-#1a202c px-10 py-5 rounded-md font-semibold text-white shadow-xl disabled:from-gray-600 disabled:to-gray-100 disabled:text-gray-100 disabled:cursor-not-allowed"
        >
